...
function sendDataToThingSpeak(latitude, longitude) {
    var apiUrl = "https://api.thingspeak.com/update?api_key=6GF7UGBT5LMP5Z27&field1=" + latitude + "&field2=" + longitude;
...
function fetchThingSpeakData() {
    var apiUrl = "https://api.thingspeak.com/channels/2517667/feeds.json?api_key=VLZH4S0FPW55OLUN&results=1";
